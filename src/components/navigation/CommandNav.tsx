                        ...
                        {items.map((item) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full text-left px-2 py-2 flex items-center justify-between border-2 transition-transform cursor-pointer ${isActive
                                ...
                                >
                                    ...
                                    {item.badge !== undefined && (
                                        <span
                                            className={`text-[9px] px-1.5 py-0.5 border ${item.id === 'character'
                                                ? 'bg-[#ef4444] text-white border-[#7f1d1d] animate-pulse'
                    ...
                    {items.map((item) => {
                        ...
                        return (
                            <button
                                key={item.id}
                                onClick={() => handleSelect(item.id)}
                                className={`relative shrink-0 px-2 py-2 font-pixel text-[9px] flex flex-col items-center justify-center border transition-all ${isActive
