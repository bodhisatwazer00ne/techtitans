            ...
            <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 font-pixel text-[10px] sm:text-xs">
                    ...
                    <button
                        ...
                        className={`px-2 py-1 border text-[9px] cursor-pointer transition-colors ${settings.soundEnabled
                    ...
                    <button
                        ...
                        className={`px-2 py-1 border text-[9px] cursor-pointer hidden md:inline-block ${settings.crtFilterEnabled
